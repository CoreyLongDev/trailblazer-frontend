...
export const About = () => {
  const peeps = [
    {
      ...
      about:
        'From humble upbringings, David has always been committed to exploring the great outdoors. He is a family man devoted to his fiance and dog.',
    ...
    },
    {
      ...
      about:
        'Software Engineer | Javascript, React, HTML, CSS, NodeJS, EXPRESS, MongoDB, MONGOOSE | Problem-Solver',
    ...
    },
    {
      ...
      about:
        'Full-stack Software developer with experience in HTML | CSS | JavaScript | Node.JS | Express.JS | Mongo | Mongoose.',
    ...
    },
    {
      ...
      about:
        'A full stack web software engineer with a love for finding solutions; my tools include React, MongoDB, Django, and Javascript. I enjoy simplifying complex workflows with DevOps tools and building scalable products with the focus of community uplifting. As a conscientious team member willing to step into any role necessary I pride myself on my work ethic while enjoying life to its fullest.',
  ...
  return (
    <>
      <h1>Our Mission</h1>
      <p>
        At TrailBlazers, we are dedicated to creating a vibrant community of
        lovers of the outdoors. We believe that everyone should wake up seeking
        ...
        {peeps.map((peep, index) => (
          <MDBCard key={index}>
            ...
            <MDBCardBody>
              ...
              <MDBCardText>{peep.about}</MDBCardText>
              <MDBCardText>
